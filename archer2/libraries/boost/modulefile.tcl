...
set boost_version TEMPLATE_BOOST_VERSION
...
proc ModulesHelp { } {
  puts stderr "Boost library version $::boost_version"
  puts stderr "See https://docs.archer2.ac.uk/software-libraries/boost/"

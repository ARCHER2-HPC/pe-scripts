...
set glm_version TEMPLATE_GLM_VERSION
...
proc ModulesHelp { } {
  puts stderr "GLM version $::glm_version"
  puts stderr "See https://docs.archer2.ac.uk/software-libraries/glm/"

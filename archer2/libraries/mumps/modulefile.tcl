...
proc ModulesHelp { } {
  puts stderr "Mumps version: TEMPLATE_MUMPS_VERSION"
  puts stderr "See https://docs.archer2.ac.uk/software-libraries/mumps/"
...
if { ! [ info exists env(PE_ENV) ] } {
  ...
  setenv PE_MUMPS_REQUIRED_PRODUCTS "PE_PARMETIS PE_SCOTCH"

  set lcName "mumps"
  set ucName [ string toupper $lcName ]

  set prod_level ${mumps_version}

...
if { ! [ info exists env(PE_ENV) ] } {
  ...
  module load parmetis/TEMPLATE_PARMETIS_VERSION
  setenv PE_SUPERLU_DIST_REQUIRED_PRODUCTS PE_PARMETIS

  # Need to have a little care here: "superlu-dist"  is the
  # directory name; everything else wants "superlu_dist".
  
  set lcName "superlu_dist"
  set ucName [ string toupper $lcName ]

  set prod_level ${superlu_dist_version}
  set prod_root ${shared_root}/libs/superlu-dist/$prod_level
